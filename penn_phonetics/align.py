...
def viterbi(input_mlf, word_dictionary, output_mlf, phoneset, hmmdir):
    os.system(
        ...
        '/hmmdefs  -S ./tmp/test.scp -i ' + output_mlf + ' -p 0.0 -s 5.0 ' + word_dictionary + ' ' + phoneset +
        ' > ./tmp/aligned.results')
...
if __name__ == '__main__':
    ...
    if sr_override is not None and sr_models is not None and not sr_override in sr_models:
